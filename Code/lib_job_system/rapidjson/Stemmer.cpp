...
size_t Stemmer::internal::getStartR1(const string& word)
{
    // special cases
...
size_t Stemmer::internal::getStartR2(const string& word,
                                            size_t startR1)
{
...
size_t
    Stemmer::internal::firstNonVowelAfterVowel(const string& word,
                                                      size_t start)
{
...
void Stemmer::internal::changeY(string& word)
{
    if (word[0] == 'y')
        word[0] = 'Y';
...
/**
  Step 0
*/
void Stemmer::internal::step0(string& word)
{
...
*/
bool Stemmer::internal::step1A(string& word)
{
...
*/
void Stemmer::internal::step1B(string& word, size_t startR1)
{
...
*/
void Stemmer::internal::step1C(string& word)
{
    size_t size = word.size();
...
*/
void Stemmer::internal::step2(string& word, size_t startR1)
{
...
*/
void Stemmer::internal::step3(string& word, size_t startR1,
                                     size_t startR2)
{
    static const vector<pair<string, string>> subs
        = {{"ational", "ate"},
...
*/
void Stemmer::internal::step4(string& word, size_t startR2)
{
    static const vector<pair<string, string>> subs
        = {{"al", ""},
           {"ance", ""},
...
*/
void Stemmer::internal::step5(string& word, size_t startR1,
                                     size_t startR2)
{
    size_t size = word.size();
    if (word[size - 1] == 'e')
 ...
 */
bool Stemmer::internal::isShort(const string& word)
{
    size_t size = word.size();
...
bool Stemmer::internal::special(string& word)
{
...
bool Stemmer::internal::endsWith(const string& word,
                                        const string& str)
{
...
bool Stemmer::internal::endsInDouble(const string& word)
{
    if (word.size() >= 2)
    {
...
bool Stemmer::internal::replaceIfExists(string& word,
                                               const string& suffix,
...
bool Stemmer::internal::containsVowel(const string& word,
